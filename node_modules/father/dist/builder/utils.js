...
exports.getBabelStyledComponentsOpts = exports.getBundlessTargets = exports.getBundleTargets = exports.ensureRelativePath = exports.getSWCTransformReactOpts = exports.getBabelPresetReactOpts = exports.getBaseTransformReactOpts = exports.addSourceMappingUrl = void 0;
...
function getBabelStyledComponentsOpts(pkg) {
    ...
    if ((_a = pkg.dependencies) === null || _a === void 0 ? void 0 : _a['styled-components']) {
        ...
        if (pkg.name) {
            ...
            const suffix = org
                ? `-${(0, crypto_1.createHash)('md5').update(org).digest('hex').slice(0, 4)}`
